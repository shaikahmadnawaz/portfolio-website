    ...
    <div className="about">
      <section className="container">
        ...
        <div className="right">
          <h1>About Me</h1>
          <p>
            Hi Everyone, I am <span>Shaik Ahmad Nawaz</span> from Pedapudi,
            Andhra pradesh, India. <br />I am pursuing B.Tech in Vasireddy
          ...
          <ul>
            ...
            I'm also a 3rd-year student pursuing Computer Science and
            Engineering at @VVIT, Guntur.
          </ul>
        </div>
      </section>
    </div>
